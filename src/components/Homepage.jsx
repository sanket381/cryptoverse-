  ...
  return (
    <>
      ...
      <Row>
        ...
        <Col span={12}><Statistic title="Total Market Cap" value={millify(global.totalMarketCap)}/></Col>
        <Col span={12}><Statistic title="Total 24th volume" value={millify(global.total24hVolume)}/></Col>
        <Col span={12}><Statistic title="Total Markets" value={millify(global.totalMarkets)}/></Col>
      </Row>
